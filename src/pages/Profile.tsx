      ...
      <div className="container mx-auto px-6 max-w-2xl">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-card rounded-2xl p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="w-24 h-24 rounded-full gradient-cyan flex items-center justify-center mb-4">
              {profile.avatar_url ? (
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="glass-card rounded-xl p-4 text-center">
              ...
              <p className="text-2xl font-bold font-mono text-foreground">{profile.total_detections}</p>
