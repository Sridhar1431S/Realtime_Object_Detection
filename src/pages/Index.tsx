...
import { Upload, Video, Zap, Shield, BarChart3, Clock, Brain, Cpu, Eye, Target, ArrowRight, Monitor, Users, Car, Building2, Scan } from "lucide-react";
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center pt-20">
          ...
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }} className="text-5xl md:text-7xl font-black leading-tight mb-6">
            Real-Time AI Object
            <br />
            <span className="text-primary glow-text">Detection & Tracking</span>
          </motion.h1>

          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.25 }} className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/detection" onClick={playClickSound} className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl gradient-cyan text-primary-foreground font-semibold hover:opacity-90 transition-opacity shadow-lg hover:shadow-xl">
              <Video className="w-5 h-5" />
              Start Webcam Detection
              <ArrowRight className="w-4 h-4" />
            </Link>
            <Link to="/detection" onClick={playClickSound} className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl border border-border bg-card text-foreground font-semibold hover:bg-secondary transition-colors shadow-sm">
              <Upload className="w-5 h-5" />
              Upload Image
            </Link>
          </motion.div>

          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.6 }} className="mt-16 max-w-4xl mx-auto">
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-6">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mt-3 mb-4">Powerful AI <span className="text-primary">Capabilities</span></h2>
            <p className="text-muted-foreground max-w-lg mx-auto">Built for speed and accuracy with state-of-the-art deep learning technology.</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div key={f.title} {...fadeUp} transition={{ delay: i * 0.1 }} className="glass-card rounded-xl p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-6">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mt-3 mb-4">Powered by <span className="text-primary">Advanced AI</span></h2>
          </motion.div>
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              <motion.div key={t.title} {...fadeUp} transition={{ delay: i * 0.1 }} className="text-center p-6">
                <div className="w-16 h-16 rounded-2xl gradient-cyan flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mt-3 mb-4">How It <span className="text-primary">Works</span></h2>
          </motion.div>
          <div className="grid md:grid-cols-5 gap-6">
            {[
              ...
              <motion.div key={s.step} {...fadeUp} transition={{ delay: i * 0.1 }} className="text-center">
                <div className="w-14 h-14 rounded-full gradient-cyan flex items-center justify-center mx-auto mb-4 text-primary-foreground font-bold text-lg">{s.step}</div>
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-6">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mt-3 mb-4">Real-World <span className="text-primary">Use Cases</span></h2>
          </motion.div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div key={uc.title} {...fadeUp} transition={{ delay: i * 0.15 }} className="glass-card rounded-2xl overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <motion.div {...fadeUp} className="text-center max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to <span className="text-primary">Try It?</span></h2>
            <p className="text-lg text-muted-foreground mb-10">Start detecting and tracking objects in real-time with our AI-powered system. No signup required.</p>
            <Link to="/detection" onClick={playClickSound} className="inline-flex items-center gap-2 px-10 py-4 rounded-xl gradient-cyan text-primary-foreground font-semibold text-lg hover:opacity-90 transition-opacity shadow-lg hover:shadow-xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-bold text-foreground">Detectra AI</span>
              </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                {[{ to: "/", label: "Home" }, { to: "/detection", label: "Detection" }, { to: "/history", label: "History" }, { to: "/statistics", label: "Statistics" }, { to: "/settings", label: "Settings" }].map(l => (
