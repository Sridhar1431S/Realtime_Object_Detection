      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center pt-20">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 text-primary text-xs sm:text-sm font-medium mb-6 sm:mb-8">
              <Zap className="w-4 h-4" />
              Powered by Deep Learning AI
            </span>
          </motion.div>

          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }} className="text-3xl sm:text-5xl md:text-7xl font-black leading-tight mb-4 sm:mb-6">
            Real-Time AI Object
            <br />
      ...
      <section className="py-16 sm:py-24 relative">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div {...fadeUp} className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mt-3 mb-4">Powerful AI <span className="text-primary">Capabilities</span></h2>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <motion.div key={f.title} {...fadeUp} transition={{ delay: i * 0.1 }} className="hover-card rounded-xl p-5 sm:p-6 group">
      ...
      <section className="py-16 sm:py-24 bg-secondary/30">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div {...fadeUp} className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mt-3 mb-4">Powered by <span className="text-primary">Advanced AI</span></h2>
          </motion.div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <motion.div key={t.title} {...fadeUp} transition={{ delay: i * 0.1 }} className="text-center p-4 sm:p-6">
                <div className="w-14 sm:w-16 h-14 sm:h-16 rounded-2xl gradient-cyan flex items-center justify-center mx-auto mb-4">
                  <t.icon className="w-7 sm:w-8 h-7 sm:h-8 text-primary-foreground" />
                </div>
      ...
      <section className="py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div {...fadeUp} className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mt-3 mb-4">How It <span className="text-primary">Works</span></h2>
          </motion.div>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 sm:gap-6">
            {[
              ...
              <motion.div key={s.step} {...fadeUp} transition={{ delay: i * 0.1 }} className="text-center">
                <div className="w-12 sm:w-14 h-12 sm:h-14 rounded-full gradient-cyan flex items-center justify-center mx-auto mb-3 sm:mb-4 text-primary-foreground font-bold text-base sm:text-lg">{s.step}</div>
                <s.icon className="w-5 sm:w-6 h-5 sm:h-6 text-primary mx-auto mb-2" />
      ...
      <section className="py-16 sm:py-24 bg-secondary/30">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div {...fadeUp} className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mt-3 mb-4">Real-World <span className="text-primary">Use Cases</span></h2>
          </motion.div>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <motion.div key={uc.title} {...fadeUp} transition={{ delay: i * 0.15 }} className="hover-card rounded-2xl overflow-hidden group">
      ...
      <section className="py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div {...fadeUp} className="text-center max-w-2xl mx-auto">
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4 sm:mb-6">Ready to <span className="text-primary">Try It?</span></h2>
