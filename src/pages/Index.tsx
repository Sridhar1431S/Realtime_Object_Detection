...
function StartDetectraButton() {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="btn-glow inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 rounded-xl gradient-cyan text-primary-foreground font-semibold transition-opacity shadow-lg text-sm sm:text-base hover:opacity-90"
    >
