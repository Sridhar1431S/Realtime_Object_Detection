    ...
    <div className="min-h-screen pt-20 pb-12">
      <div className="container mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-muted-foreground mb-8">Review all past detection events.</p>
        </motion.div>
        ...
        <div className="flex flex-wrap items-center gap-3 mb-6">
          ...
          {history.length > 0 && (
            <button
              onClick={handleClear}
              className="ml-auto inline-flex items-center gap-1.5 px-4 py-2.5 rounded-lg bg-destructive/10 text-destructive text-sm font-medium hover:bg-destructive/20 transition"
            >
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {paged.map((h) => (
                  ...
                  >
                    <td className="px-5 py-3 font-medium text-foreground capitalize">{h.objectName}</td>
                    ...
                    <td className="px-5 py-3 text-muted-foreground">{new Date(h.timestamp).toLocaleString()}</td>
                    <td className="px-5 py-3">
